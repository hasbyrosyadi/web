<?php
/*
Plugin Name: WonderPlugin Video Embed 
...
define('WONDERPLUGIN_VIDEOEMBED_VERSION', '1.3');
...
define('WONDERPLUGIN_VIDEOEMBED_PLUGIN_VERSION', '1.3');
...
class WonderPlugin_Videoembed_Plugin {
	...
	{
		$menu = add_menu_page(
				__('WonderPlugin Video Embed', 'wonderplugin_videoembed'),
				__('WonderPlugin Video Embed', 'wonderplugin_videoembed'),
				'manage_options',
	...
	function enqueue_admin_creator_script($hook)
	{
		...
		wp_localize_script('jquery', 'WONDERPLUGIN_VIDEO_MCE_EDITOR', array('pluginurl' => WONDERPLUGIN_VIDEOEMBED_URL, 'helpurl' => admin_url('admin.php?page=wonderplugin_videoembed_show_quick_start'), 'lightboxinstalled' => class_exists('WonderPlugin_Lightbox_Plugin')));
	}
