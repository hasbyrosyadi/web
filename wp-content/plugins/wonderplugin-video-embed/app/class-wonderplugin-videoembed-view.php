...
class WonderPlugin_Videoembed_View {
	...
	function add_metaboxes() {
		add_meta_box('overview_features', __('WonderPlugin Video Embed Features', 'wonderplugin_videoembed'), array($this, 'show_features'), 'wonderplugin_videoembed_overview', 'features', '');
	...
	function show_features() {
		...
		<ul class="wonderplugin-feature-list">
			...
			<li>Work on mobile, tablets and all major web browsers, including iPhone, iPad, Android, Firefox, Safari, Chrome, Opera, Internet Explorer 8/9/10/11 and Edge</li>
			<li>Fully responsive</li>
			<li>Insert videos to sidebar widget</li>
			<li>Insert videos into pages and posts</li>
			<li>Play in lightbox popup (working together with our premium plugin <a href="https://www.wonderplugin.com/wordpress-lightbox/?product=videoembed" target="_blank">WonderPlugin Lightbox</a>)</li>
	...
	function print_overview() {
		...
		<h2><?php echo __( 'WonderPlugin Video Embed', 'wonderplugin_videoembed' ) . (WONDERPLUGIN_VIDEOEMBED_VERSION_TYPE == "L" ? "" : ((WONDERPLUGIN_VIDEOEMBED_VERSION_TYPE == "C") ? " Commercial Version" : " Free Version")) . " " . WONDERPLUGIN_VIDEOEMBED_VERSION; ?> </h2>
	...
	function print_quick_start() {
		...
		<p>To insert a video to WordPress sidebar widget, log into WordPress backend, click menu Appearance -> Widget. Drag the widget WonderPlugin Video Embed to the Widget Area.</p>
		...
		<p>To insert a video to post or page, in WordPress post editor or page editor, switch to Visual mode, then click the button WonderPlugin Video Embed.</p>
		...
		<ul style="list-style-type: square;padding-left:18px;">
		<li style="color:#ff0000;">To play video in Lightbox, the plugin <a href="https://www.wonderplugin.com/wordpress-lightbox/" target="_blank">WonderPlugin Lightbox</a> must be installed and activated.</li>
		...
		?> <div style="padding-left:10px;padding-top:12px;"> <?php
			if (empty($key)) { ?>
				...
				<tr>
					...
					<td><input name="wonderplugin-videoembed-key" type="text" id="wonderplugin-videoembed-key" value="" class="regular-text" /> <input type="submit" name="save-videoembed-license" id="save-videoembed-license" class="button button-primary" value="Register License Key"  />
					</td>
				</tr>
				</table>
				</form>
